...
void show_load(hashTable table)
{
    ...
    cout << fixed << setprecision(2) << "** N = " << right << setw(6) << table.bucket_count() << " load = " << percent_inuse << "\n";
}
...
int main(int argc, char *argv[])
{
    ...
    while (cin >> key)
    {
        ...
        // Double for loop is because the bucket has the line numbers in reverse order,
        // and I was having issues decrementing through the bounds
